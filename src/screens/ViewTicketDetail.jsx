...
const styles = StyleSheet.create({
  ...
  messageBubble: { padding: 10, marginVertical: 4, borderRadius: 8, maxWidth:'90%', },
  incoming: { backgroundColor: '#FFEA00', alignSelf: 'flex-end', },
  outgoing: { backgroundColor: '#e5e5e5', alignSelf: 'flex-start', },
  ...
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#eee', justifyContent: 'space-around', alignItems: 'center', paddingHorizontal: 16, paddingTop: 10, paddingBottom: 25, shadowColor: '#000',
  ...
  ReplyStyle:{ backgroundColor:'#000', padding:20, marginBottom:110, color:'#fff', borderRadius:8, textAlign:'center' },
  refreshIcon:{ width:15, height:16, marginRight:5, },
  attachmentImage:{ width:'85%', height:200, objectFit:'contain', resizeMode: 'contain', },
  video: { width: '300', height: 270, borderRadius: 8, marginTop: 5, },
  ...
  messageInput: { borderWidth: 1, borderColor: '#ddd', borderRadius: 10, padding: 12, fontSize: 14, color: '#000', minHeight: 120, marginBottom: 12, },
  filePreviewScroll: { marginBottom: 12 },
  filePreviewItem: { marginRight: 10, position: 'relative', alignItems: 'center', },
  filePreviewImage: { width: 80, height: 80, borderRadius: 8, backgroundColor: '#eee', },
  removeFileBtn: { position: 'absolute', top: 0, right: 0, backgroundColor: '#ff4444', borderRadius: 10, width: 20, height: 20, justifyContent: 'center', alignItems: 'center', },
  removeFileBtnText: { color: '#fff', fontSize: 10, fontWeight: '700' },
  filePreviewName: { fontSize: 10, color: '#666', marginTop: 4, maxWidth: 80, },
  modalActions: { flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', gap: 10, },
  uploadBtn: { width: '100%', borderWidth: 1, borderColor: '#000', borderRadius: 8, padding: 14, alignItems: 'center', },
  uploadBtnText: { color: '#000', fontWeight: '600', fontSize: 14 },
  sendBtn: { width: '100%', backgroundColor: '#FFEA00', borderRadius: 8, padding: 14, alignItems: 'center', },
